...
public partial class FluentUnstyledSortableList<TItem> : FluentComponentBase
{
    private const string JAVASCRIPT_FILE = "./Components/Components/FluentUnstyledSortableList/FluentUnstyledSortableList.razor.js";
    private DotNetObjectReference<FluentUnstyledSortableList<TItem>>? _selfReference;
    ...
    /// </summary>
    [Parameter]
    public EventCallback<FluentUnstyledSortableListEventArgs> OnUpdate { get; set; }

    /// <summary>
    /// Event callback for when an item is removed from the list.
    /// </summary>
    [Parameter]
    public EventCallback<FluentUnstyledSortableListEventArgs> OnRemove { get; set; }
    ...
    public void OnUpdateJS(int oldIndex, int newIndex)
    {
        if (OnUpdate.HasDelegate)
        {
            ...
            OnUpdate.InvokeAsync(new FluentUnstyledSortableListEventArgs(oldIndex, newIndex));
        }
    }
    ...
    public void OnRemoveJS(int oldIndex, int newIndex)
    {
        if (OnRemove.HasDelegate)
        {
            ...
            OnRemove.InvokeAsync(new FluentUnstyledSortableListEventArgs(oldIndex, newIndex));
        }
    }
